...
final class MollieMethodsCreatorHelper implements MollieMethodsCreatorHelperInterface
{
    ...
    public function createMethods(MethodCollection $allMollieMethods, GatewayConfigInterface $gateway): void
    {
        ...
        foreach ($allMollieMethods as $mollieMethod) {
            if (in_array($mollieMethod->id, MollieMethodsCreatorInterface::UNSUPPORTED_METHODS)) {
                continue;
            }
            ...
            if (
                ...
                (
                    false === in_array($mollieMethod->id, MollieMethodsCreatorInterface::RECURRING_PAYMENT_SUPPORTED_METHODS) &&
                    false === in_array($mollieMethod->id, MollieMethodsCreatorInterface::RECURRING_PAYMENT_INITIAL_METHODS)
                )
            ) {
                continue;
            }
