...
Feature: Paying with Mollie during checkout
    ...
    Scenario: Successful payment
        ...
        And I sign in to Mollie and pay successfully
    ...
    Scenario: Cancelling the payment
        ...
        And I have proceeded selecting "Mollie" payment method
        When I confirm my order with Mollie payment
        And I cancel my Mollie payment
    ...
    Scenario: Retrying the payment with success
        Given I added product "PHP T-Shirt" to the cart
        And I have proceeded selecting "Mollie" payment method
        And I have confirmed my order with Mollie payment
        But I have cancelled Mollie payment
