...
final class Version20231214133331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        for ($i = 0; $i < 16; $i++) {
            $this->addSql("INSERT INTO mollie_configuration_amount_limits (min_amount, max_amount) VALUES (NULL, NULL)");
        }
        $this->addSql('UPDATE mollie_configuration SET amount_limits_id = id');
    }
